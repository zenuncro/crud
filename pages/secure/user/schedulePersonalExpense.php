...
<body style="background-image: linear-gradient(to right, #FFA200 , #FFC300);">
        <header class="pb-3 mb-4 border-bottom d-flex justify-content-between align-items-center">
            <a href="../../../pages/secure/" class="text-dark text-decoration-none logo">
                <img src="../../../assets/images/uploads/logo.png" alt="ESTG" class="mw-100">
            </a>
            <div class="header-text mb-4 text-center">
                <h1 class="display-5 fw-bold">Calendarizar Despesa</h1>
            </div>
            <form action="../../../pages/secure/" method="post">
        ...
        <div class="col-md-6">
            <div class="card mt-2" style="border-radius: 10px; box-shadow: 5px 5px 10px #888888; background-color:#cfdbd5;">
                <div class="card-body">
                    ...
                    <form class="scheduleExpenseForm" action="../../../controllers/auth/scheduleExpense.php" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col rodape">
            <ul>
                ...
                <li style="margin-right: 20px;"><a href="https://github.com/Caselhos" target="_blank"><img src="../../../assets/images/uploads/GitHubLogo.png" class="GitHubLogo" ></a>Gonçalo Caselhos</li>
                <li><a href="https://github.com/zenuncro" target="_blank"><img src="../../../assets/images/uploads/GitHubLogo.png" class="GitHubLogo"></a>João Araújo</li>
            </ul>
        </div>
    </div>
</footer>
